...
<div >
  ...
  <div style="margin-top: 72px" class="swiper-container  swiper-container-horizontal swiper-container-ios" id="page">
    <div class="swiper-wrapper">
                  ...
                  <div class="secKillMain">
                    <div class="swiper-container1 flashSaleList">
                      <div class="swiper-wrapper" id="bursting" >
                          ...
                          <div v-for="(items ,index) in listSecKillSpecial"  :class="index2 === 0?'swiper-slide bursNav burCur ':'swiper-slide bursNav'" >
      ...
      <div class="swiper-slide slidepage">
        ...
        <div class="swiper-container scroll swiper-container-vertical swiper-container-free-mode swiper-container-ios">
          <div class="swiper-wrapper" style="height: 7000px">
            <div class="swiper-slide slidescroll" style="height: auto">

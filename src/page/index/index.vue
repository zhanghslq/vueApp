  ...
  <a  class="cityCode">北京市 <em class="triangle"></em></a>
    ...
    <div class="swiper-container swiper-container-horizontal swiper-container-free-mode swiper-container-ios" id="nav">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide"><span>美妆护肤</span></div>
        <div class="swiper-slide"><span>百货轻奢</span></div>
        <div class="swiper-slide"><span>母婴玩具</span></div>
        <div class="swiper-slide"><span>滋补保健</span></div>
        <div class="swiper-slide"><span>休闲零食</span></div>
        <div class="swiper-slide"><span>乳饮酒速食</span></div>
        <div class="swiper-slide"><span>水果蔬菜</span></div>
        <div class="swiper-slide"><span>百货家居</span></div>
        <div class="swiper-slide"><span>服饰箱包</span></div>
        <div class="swiper-slide"><span>生鲜肉类</span></div>
        <div class="swiper-slide"><span>猩际物料</span></div>
      </div>
    </div>
  </div>
  ...
  <div class="swiper-container  swiper-container-horizontal swiper-container-ios" id="page">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slidepage">
        <div class="swiper-container scroll swiper-container-vertical swiper-container-free-mode swiper-container-ios">
          <div class="swiper-wrapper">
            <div id="two" class="swiper-slide slidescroll">
              <div class="homePageMain">
                <!--轮播图-->
                <div class="carouseContent swiper-no-swiping">
                  <div >
